...
class DataLoader:
    ...
    def _load_data(self):
        ...
        for index in range(len(config['dataset'][self.dataset_type])):
            ...
            filename_datalist = PurePath(Path(__file__).resolve().parent).joinpath(filename_datalist)
            ...
            filename_labellist = PurePath(Path(__file__).resolve().parent).joinpath(filename_labellist)
