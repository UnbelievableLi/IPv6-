...
from posture.SPPE.src.utils.img import load_image, cropBox, im_to_torch
from posture.opt import opt
from posture.yolo.preprocess import prep_image, prep_frame, inp_to_image
from posture.pPose_nms import pose_nms, write_json
from posture.SPPE.src.utils.eval import getPrediction, getMultiPeakPrediction
from posture.yolo.util import write_results, dynamic_write_results
from posture.yolo.darknet import Darknet
import cv2
import numpy as np
import sys
import time
...
if opt.vis_fast:
    from posture.fn import vis_frame_fast as vis_frame
else:
    from posture.fn import vis_frame
...
class DetectionLoader:
    def __init__(self, dataloder, batchSize=1, queueSize=1024):
        # initialize the file video stream along with the boolean
        # used to indicate if the thread should be stopped or not
        self.det_model = Darknet("posture/yolo/cfg/yolov3-spp.cfg")
        self.det_model.load_weights('posture/models/yolo/yolov3-spp.weights')
